...
export default function EntryDetailPage() {
                ...
                <CardContent className="pt-6">
                  <div className="text-center py-8">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 mb-6">
                      The journal entry you're looking for doesn't exist or you
                      don't have permission to view it.
                    </p>
                    <Link href="/">
                      <a className={buttonVariants()}>Back to Dashboard</a>
                    </Link>
                  </div>
                </CardContent>
              </Card>
  ...
  const sentimentAnalysis = entry.sentimentAnalysis
    ? JSON.parse(JSON.stringify(entry.sentimentAnalysis))
    : null;
